...
<div class="container">
    ...
    <div class="container bg-secondary" style="text-align:center;">
        ...
        <div id="setting" class="py-4 text-light">
            ...
            <br>
            <p>Speed:
                <input id="speed1" type="radio" name="speed" value="75"/>
                <label for="speed1">Slow</label>
                <input id="speed2" type="radio" name="speed" value="50" checked /> <!-- Added checked to end of the speed you want to be default -->
